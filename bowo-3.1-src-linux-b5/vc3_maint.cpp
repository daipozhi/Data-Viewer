//------------------------------------
// 1,mark     regist function
// 2,mark     DrawFocusRect(hdc,&rt);
// 3,mark     fseek(s_fp1,(long)lp,0);
//
//
//
//-----------------------------------
...
//  long    recno;
  ...
  switch(msg)    
  {
    ...
    case WM_SETFOCUS:
    {
      ...
      if (GetFocus()==hwnd)
      {
	CreateCaret(hwnd,0,0,(int)bw_main1.win_edit_ychar);
	ShowCaret(hwnd);
      }
...
//	ReleaseDC(win_hwnd,hdc);
	...
	if (str[0]=='?') bw_dialog1.w_mv_get_read_paint(str,SMG_LEN,bw_main1.win_hnd_id,'g');
      ...
      set_cursor(hwnd,bw_win1.pline+1-bw_win_bua1.get_win_con(bw_main1.win_hnd_id,1),bw_win1.pfield+1-bw_win_bua1.get_win_con(bw_main1.win_hnd_id,0));
...
*/
	...
	if (str[0]=='@')
	{
	  ...
	  InvalidateRect(bw_win_bua1.get_win_hnd(i),0,TRUE);
...
//	  hcursor=LoadCursor(NULL,"cursor2.cur");
    ...
    case WM_PROGRAM1:
      ...
      bw_get_bua1.set_smg_string(bw_win_bua1.get_win_pp11(bw_main1.win_hnd_id),str2,SMG_LEN);

      break;
    
    case WM_PROGRAM2:

      bw_win_bua1.set_win_linep(bw_main1.win_hnd_id,0,lp-1+bw_win_bua1.get_win_con(bw_main1.win_hnd_id,1));
      bw_win_bua1.set_win_linep(bw_main1.win_hnd_id,1,wp-1+bw_win_bua1.get_win_con(bw_main1.win_hnd_id,0));
...
int bw_main::get_view(char *p_str,int len,HWND hwnd,int pp5)
{
  ...
  //MessageBox(bw_main1.win_hwnd1,"aa","aa",MB_OK);
...
*/
  ...
  //MessageBox(bw_main1.win_hwnd1,"win file ok ,cc","cc",MB_OK);
  ...
  //MessageBox(bw_main1.win_hwnd1,"tb1 ok ,dd","dd",MB_OK);
  ...
  //MessageBox(bw_main1.win_hwnd1,"tb4 ok ,ee","ee",MB_OK);
  ...
  //MessageBox(bw_main1.win_hwnd1,"tb6 ok ,ff","ff",MB_OK);
  ...
  //MessageBox(bw_main1.win_hwnd1,"tb5 ok ,gg","gg",MB_OK);
  ...
  //MessageBox(bw_main1.win_hwnd1,"tb2 ok,hh","hh",MB_OK);
  ...
  //MessageBox(bw_main1.win_hwnd1,"tb3 ok ,ii","ii",MB_OK);
  ...
  //MessageBox(bw_main1.win_hwnd1,"dbf ok,jj","jj",MB_OK);
  ...
  //MessageBox(bw_main1.win_hwnd1,"close dbf ok,kk","kk",MB_OK);
...
*/
  ...
  //MessageBox(bw_main1.win_hwnd1,"create win ok ,ll","ll",MB_OK);
