...
class bw_main_bua     bw_main_bua1;
class bw_fldstru_bua  bw_fldstru_bua1;
class bw_menuvar_bua  bw_menuvar_bua1;
class bw_choose_bua   bw_choose_bua1;
class bw_switch_bua   bw_switch_bua1;
class bw_dialog_bua   bw_dialog_bua1;
class bw_get_bua      bw_get_bua1;
class bw_xbase_bua    bw_xbase_bua1;
class bw_print_buc    bw_print_buc1;
class bw_print_bub    bw_print_bub1;
class bw_print_bua    bw_print_bua1;
class bw_link_bua     bw_link_bua1;
class bw_edit_bua     bw_edit_bua1;
class bw_win_bub      bw_win_bub1;
class bw_win_bua      bw_win_bua1;
class bw_buff         bw_buff1;
class bw_buffa        bw_buffa1;
...
long /*FAR PASCAL*/ w_main_wp(HWND hwnd,UINT msg,WPARAM wp,LPARAM lp)
{
...
*/
    ...
    case WM_PAINT:
      ...
      bw_main_bua1.get_win_face_bmp1(bw_main1.win_face_pp2,bw_main1.win_face_bmp0,FN_SIZE);
...
*/
      ...
      if (wp==1226) bw_edit_bua1.tst_dirn_file();
