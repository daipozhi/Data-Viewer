...
class bw_font
{
  ...
  public:
    ...
    int   w_font_ini(void);
    int   w_read_fdc(char *p_fn1,int wpp);
...
class bw_edit
{
  ...
  public:
    ...
    int  get_edit(char *fn,int wpp,HWND hwnd);
...
class bw_xbase_bua
{
  ...
  private:
    ...
    int  win_state7[STRU_NUM][WIN_NUM];  /* find mark */
...
class bw_main
{
  ...
  public:
    ...
    int  w_set_lbutt(HWND hwnd,int hnd_id);
...
class bw_dialog
{
  ...
  public:
	 ...
	 int      w_save_mem(char *s1,int len1,int wpp,char *s2,int len2);
...
class bw_menuvar_bua
{
  ...
  public:
    ...
    int      get_t5_m_butt(int mpp,char *s1,int len);
    int      set_t5_m_butt(int mpp,char *s1,int len);
    int      setc_t5_m_butt(int mpp,int pp1,int val);
...
class bw_win
{
  ...
  public:
    ...
    int w_cre_ci_butt(int p_pagecnt,char *s1,int len,int p6,int p7,int p8,int i,char *,int);
...
class bw_inkey
{
  ...
  public:
    ...
    int strltrim(char *str);
    int strpcut(char *p_s1,int p1,int p2,int len1,char *p_s2,int len2);
    int char2long(char *str,long *l);
    int char2float(char *str,float *l);
    int char2int(char *string,int p1,int p2);
    int int2char(int val,char *string);
    int float2char(float val,char *str);
    int long2char(long l,char *str);
