...
int bw_xbase::w_find_empty_file(char *p_str,int p_str_len,int p_fcnt)
{
  ...
  for (i=1;i<=36;i++)
  {
    ...
    for (j=1;j<=36;j++)
    {
      ...
      //sprintf(str,"find file =%s,return=%d,",s_stc2,l);
      //bw_getread1.deb_record(str);
