...
*/
  ...
  public:
    ...
    char       get_t_winfile(int wpp,int line,int col);
    int        set_t_winfile(int wpp,int line,int col,char val);
};
...
class bw_font
{
  ...
  public:
    ...
    int   w_font_ini(void);
    int   w_read_fdc(char *p_fn1,int p_fn1_size,int wpp);
...
class bw_bmp
{
  ...
  public:
    ...
    int      echo_bmp(HWND hwnd,char *comm,int comm_size,int mcnt,int wpp);

    int      w_bmp_add(int p_fcnt,int wpp,char *fldname,int fldname_size);
...
class bw_print
{
  ...
  public:
    ...
    int w_open_print(char *p_s1,int p_s1_size);
  ...
  public:
    ...
    int w_print(int wpp,char *s1,int s1_size);       /* public*/
...
{
*/
/* t6_ t5_ t4_ t2_ t_ is module name */
  ...
  public:
    ...
    int   get_ts_field(int fpp,char *s1,int s1_size);
    int   set_ts_field(int fpp,char *s1,int s1_size);
...
*/
  ...
  public:
    ...
    int  get_t6s_tmpc2(int lpp,char *s1,int s1_size);
};
...
class bw_link
{
  ...
  public:
    ...
    int w_read_link(char *fn,int fn_size,int wpp,int num);
    int w_find_link_tn(char *tmpc1,int tmpc1_size,int wpp,int i);
    ...
    int w_link_modi_set(char *tn,int tn_size,char *fn,int fn_size,int p1,int wpp);
    ...
    int w_get_sv(int wpp,int base,int seri,int recn,char *str,int str_size);
...
class bw_mbase
{
  public:
    ...
    int  w_open_base(char *bn,int bn_size,int p_fcnt);
...
class bw_xbase
{
  ...
  public:
    ...
    int  w_open_xbase(char *p_fn1,int p_fn1_size,int backup,int p_fcnt);
    int  w_close_xbase(int p_fcnt);
    int  w_login_xbase(int pp);
    int  w_free_xbase(void);
    int  w_dele_state(int p_fcnt);
    int  w_create_xbase(char *p_fn12,int p_fn12_size,int p_fcnt);
    ...
    int  w_commit_xbase(int backup,int p_fcnt);
    int  w_rollback_xbase(/*char *p_fn1,int p_fn1_size,*/int backup,int p_fcnt);
    int  w_append_sdf(char *p_fn,int p_fn_size,int p_fcnt);
    int  w_copy_sdf(char *p_fn,int p_fn_size,int p_fcnt);
    int  w_zap_xbase(int p_fcnt);
    int  w_clr_recvar(int p_fcnt);
    int  w_find_empty_file(char *str,int str_size,int p_fcnt);
    int  w_find_empty_ffile(char *str,int str_size,int wpp);
    int  w_find_empty_mfile(char *str,int str_size,int p_fcnt);
    int  w_use_fox(char *fn1,int fn1_size);
    int  w_append_fox(int p_fcnt);
    int  w_go_fox(long r);
    int  w_close_fox(void);
    int  w_bcpy_var(int p_fcnt,char *p_fld,int p_fld_size,char *p_stc4,int p_stc4_size);
    int  w_bsav_var(int p_fcnt,char *p_fld,int p_fld_size,char *p_stc4,int p_stc4_size);
...
*/
  ...
  public:
    ...
    int  get_win_state_in_srch(int wpp,int spp);
    ...
    int  set_win_state_in_srch(int wpp,int spp,int val);
    ...
    int  get_win_scrnvar(int wpp,char *s1,int s1_size);
    int  set_win_scrnvar(int wpp,char *s1,int s1_size);
    ...
    int  get_win_fext(int wpp,char *s1,int s1_size);
...
class bw_main
{
  public:
    ...
    char   win_m_tc0[FN_SIZE];
    char   win_m_tc1[FN_SIZE];
    char   win_m_tc2[FN_SIZE];
    char   win_m_tc3[FN_SIZE];
    char   win_m_tc4[FN_SIZE];
    char   win_m_tc5[FN_SIZE];
    char   win_m_tc6[FN_SIZE];
    char   win_m_tc7[FN_SIZE];
    //char   s_tc8[FN_SIZE];
    //char   s_tc9[FN_SIZE];
    //char   s_tca[FN_SIZE];
...
class bw_dialog
{
  ...
  public:
	 ...
	 int      w_read_ddc(char *p_fn,int p_fn_size,int wpp);
	 int      w_mv_save_mem(char *s1,int s1_size,int wpp,char *s2,int s2_size);
	 ...
	 int      w_mv_add_val(char *s1,int s1_size,int wpp,char *s2,int s2_size);
	 int      w_mv_fet_val(char *s1,int s1_size,int wpp,char *s2,int s2_size);
	 int      w_mv_sav_var(char *s1,int s1_size,int wpp);
	 int      w_mv_get_var(char *s1,int s1_size,int wpp);
	 int      w_mv_exist(char *s1,int s1_size,int wpp);
         int      w_mv_add_name(char *p_tmpc1,int p_tmpc1_size);
	 int      w_mv_seri(char *p_tmpc1,int p_tmpc1_size,int wpp);
         int      w_mv_move_aft(int dd,int num);
	 int      w_mv_move_bef(int dd,int num);
	 int      w_echo_winrec_var(int wpp);
	 int      w_mv_get_read_paint(char *s1,int s1_size,int wpp,char comm);
	 int      w_mv_get_read_g(char *s1,int s1_size,int wpp,char comm);
	 int      w_mv_get_read_r(char *s1,int s1_size,int wpp,char comm);
...
*/
  ...
  public:
    ...
    int      get_win_mv_getv(int wpp,char *s1,int s1_size);
    int      set_win_mv_getv(int wpp,char *s1,int s1_size);
...
class bw_switch
{
  ...
  public:
    ...
    int w_read_sdc(char *p_fn1,int p_fn1_size,int wpp);
...
class bw_choose
{
  ...
  public:
    ...
    int w_read_cdc(char *p_fn1,int p_fn1_size,int wpp);
...
class bw_menuvar
{
  ...
  public:
    ...
    int w_read_mdc(char *p_fn1,int p_fn1_size,int wpp);
...
class bw_fldstru
{
  ...
  public:
    ...
    int w_tv_get_read_paint(char *fn,int fn_size,int wpp,int l,int c,char comm);
    int w_tv_get_read_g(char *fn,int fn_size,int wpp,int l,int c,char comm);
    int w_tv_get_read_r(char *fn,int fn_size,int wpp,int l,int c,char comm);
    int w_get_tab_var(char *fn,int fn_size,int p_fcnt,char *ca,int ca_size);
    int w_cmp_tab_var(char *fn,int fn_size,int p_fcnt,char *ca,int ca_size);
    int w_sav_tab_var(char *fn,int fn_size,int p_fcnt,char *ca,int ca_size);
    ...
    int w_edit_memo(int p_fcnt,int wpp,char *fldname,int fldname_size);
    int w_edit_memo_close(int wpp);
    int w_edit_memo_add(int p_fcnt,int wpp,char *fldname,int fldname_size);
...
*/
  ...
  public:
    ...
    int w_have_next_rec2(int p_fcnt,int wpp,int recno);
    int w_have_prev_rec2(int p_fcnt,int wpp,int recno);
...
class bw_win
{
  ...
  public:
    ...
    int w_dele_win_pp_wins_dbf(int wpp);
    ...
    int w_echo_win_check(int p_pagecnt,int mark);
    ...
    int w_fetch_fld_style(char *tfn,int tfn_size,char *tn,int tn_size,long *tr,char *fn,int fn_size,int wpp);
    int w_find_base_name(char *str,int str_size,int wpp);
    int w_find_fld_name(char *str,int str_size,int wpp);
    int w_find_recno_name(char *str,int str_size);
    int w_fld_set_base(char *p_fldtable,int p_fldtable_size,int pp1,int wpp);
...
*/
    int  get_win_state_link_modi(int wpp);         /* link modified */
    int  set_win_state_link_modi(int wpp,int val); /* link modified */
    int  get_win_state_calc_modi(int wpp);         /* calc modified */
    int  set_win_state_calc_modi(int wpp,int val); /* calc modified */

    int  get_win_switch_bmp(int wpp);
    int  set_win_switch_bmp(int wpp,int val);

    int  get_win_pp_fld_in_win(int wpp,int pp);   /* tab in scrn cur&first&last&echo win pp */
    int  set_win_pp_fld_in_win(int wpp,int pp,int val);
    int  get_win_h_w_pp(int wpp,int pp);  /* tow star,end,cur,parent pp.parent foc*/
    int  set_win_h_w_pp(int wpp,int pp,int val);
    int  get_win_h_up_pp(int wpp,int pp);  /* up scrn seg posi */
    int  set_win_h_up_pp(int wpp,int pp,int val);

    HWND get_win_phh(int wpp);          /* win_pp_grp_pp's windows handle */
    int  set_win_phh(int wpp,HWND hwnd);

    int get_win_pp_win_mark(int wpp);
    int set_win_pp_win_mark(int wpp,int val);
    int get_win_pp_grp_id(int wpp);
    int set_win_pp_grp_id(int wpp,int val);
    int get_win_pp_grp_pp(int wpp,int pp04);
    int set_win_pp_grp_pp(int wpp,int pp04,int val);
    int get_win_pp_wins_dbf(int p_fcnt,int wpp);
    int set_win_pp_wins_dbf(int p_fcnt,int wpp,int val);
    int get_win_pp_get_rd(int wpp);
    int set_win_pp_get_rd(int wpp,int val);
...
*/
  ...
  public:
    ...
    int  get_win_window_name(int wpp,char *s1,int s1_size);
    int  set_win_window_name(int wpp,char *s1,int s1_size);
    int  get_win_find_name(int wpp,char *s1,int s1_size);
    int  set_win_find_name(int wpp,char *s1,int s1_size);
};
