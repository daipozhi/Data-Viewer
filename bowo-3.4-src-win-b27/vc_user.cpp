...
int bw_user::w_user_triger(char *p_win,int p_win_size,char *p_msg,int p_msg_size,char *p_itm,int p_itm_size,char *p_stt,int p_stt_size)
{
      ...
      (strncmp(p_msg,"WM_CLOSE",8)==0))
  {
    ...
    {
      bw_dialog1.w_mv_fet_val("fdca1",6,0,str,SMG_SIZE);
      i=bw_inkey1.str2int(str,SMG_SIZE);
    }
    ...
    {
      bw_dialog1.w_mv_fet_val("fdca2",6,0,str,SMG_SIZE);
      i=bw_inkey1.str2int(str,SMG_SIZE);
    }
    ...
    {
      bw_dialog1.w_mv_fet_val("fdca3",6,0,str,SMG_SIZE);
      i=bw_inkey1.str2int(str,SMG_SIZE);
    }
    ...
    {
      bw_dialog1.w_mv_fet_val("fdca4",6,0,str,SMG_SIZE);
      i=bw_inkey1.str2int(str,SMG_SIZE);
    }
    ...
    {
      bw_dialog1.w_mv_fet_val("fdca5",6,0,str,SMG_SIZE);
      i=bw_inkey1.str2int(str,SMG_SIZE);
    }
    ...
    {
      bw_dialog1.w_mv_fet_val("fdca6",6,0,str,SMG_SIZE);
      i=bw_inkey1.str2int(str,SMG_SIZE);
    }
    ...
    {
      bw_dialog1.w_mv_fet_val("fdca7",6,0,str,SMG_SIZE);
      i=bw_inkey1.str2int(str,SMG_SIZE);
    }
    ...
    {
      bw_dialog1.w_mv_fet_val("fdcb1",6,0,str,SMG_SIZE);
      i=bw_inkey1.str2int(str,SMG_SIZE);
    }
    ...
    {
      bw_dialog1.w_mv_fet_val("fdcb2",6,0,str,SMG_SIZE);
      i=bw_inkey1.str2int(str,SMG_SIZE);
    }
    ...
    {
      bw_dialog1.w_mv_fet_val("fdcb3",6,0,str,SMG_SIZE);
      i=bw_inkey1.str2int(str,SMG_SIZE);
    }
    ...
    {
      bw_dialog1.w_mv_fet_val("fdcb4",6,0,str,SMG_SIZE);
      i=bw_inkey1.str2int(str,SMG_SIZE);
    }
    ...
    {
      bw_dialog1.w_mv_fet_val("fdcb5",6,0,str,SMG_SIZE);
      i=bw_inkey1.str2int(str,SMG_SIZE);
    }
    ...
    {
      bw_dialog1.w_mv_fet_val("fdcb6",6,0,str,SMG_SIZE);
      i=bw_inkey1.str2int(str,SMG_SIZE);
    }
    ...
    {
      bw_dialog1.w_mv_fet_val("fdcb7",6,0,str,SMG_SIZE);
      i=bw_inkey1.str2int(str,SMG_SIZE);
    }
    ...
    {
      bw_dialog1.w_mv_fet_val("fdcb8",6,0,str,SMG_SIZE);
      i=bw_inkey1.str2int(str,SMG_SIZE);
    }
    ...
    {
      bw_dialog1.w_mv_fet_val("fdcb9",6,0,str,SMG_SIZE);
      i=bw_inkey1.str2int(str,SMG_SIZE);
    }
    ...
    {
      bw_dialog1.w_mv_fet_val("fdcb10",7,0,str,SMG_SIZE);
      i=bw_inkey1.str2int(str,SMG_SIZE);
    }
    ...
    {
      bw_dialog1.w_mv_fet_val("fdcb11",7,0,str,SMG_SIZE);
      i=bw_inkey1.str2int(str,SMG_SIZE);
    }
    ...
    {
      bw_dialog1.w_mv_fet_val("fdcb12",7,0,str,SMG_SIZE);
      i=bw_inkey1.str2int(str,SMG_SIZE);
    }
    ...
    {
      bw_dialog1.w_mv_fet_val("fdcb13",7,0,str,SMG_SIZE);
      i=bw_inkey1.str2int(str,SMG_SIZE);
    }
