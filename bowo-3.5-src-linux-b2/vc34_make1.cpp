...
/*
	...
	strcpy(bw_main1.win_m_tc0,bw_main1.win_seaname);
	strcpy(bw_main1.win_m_tc6,"Select File To Run");
	bw_main1.dlg_f1.lStructSize=sizeof(OPENFILENAME);
	bw_main1.dlg_f1.hwndOwner=bw_main1.win_hwnd;
	strcpy(bw_main1.win_m_tc1,"ALL Text File");
	strcat(bw_main1.win_m_tc1,"(");
	strcat(bw_main1.win_m_tc1,bw_main1.win_m_tc0);
	strcat(bw_main1.win_m_tc1,")");
	j=strlen(bw_main1.win_m_tc1);
	for (i=0;i<=(int)strlen(bw_main1.win_m_tc0);i++) bw_main1.win_m_tc1[j+1+i]=bw_main1.win_m_tc0[i];
	bw_main1.win_m_tc1[j+1+i]=0;
	bw_main1.dlg_f1.lpstrFilter=bw_main1.win_m_tc1;
	bw_main1.dlg_f1.nFilterIndex=1;
	strcpy(bw_main1.win_m_tc2,bw_main1.win_m_tc0);
	bw_main1.dlg_f1.lpstrFile=bw_main1.win_m_tc2;
	bw_main1.dlg_f1.nMaxFile=FN_SIZE;
	bw_main1.dlg_f1.lpstrFileTitle=bw_main1.win_m_tc3;
	bw_main1.dlg_f1.nMaxFileTitle=FN_SIZE;
	bw_main1.dlg_f1.lpstrInitialDir=NULL;
	bw_main1.dlg_f1.lpstrTitle=bw_main1.win_m_tc6;
	strcpy(bw_main1.win_m_tc4,"txt");
	bw_main1.dlg_f1.lpstrDefExt=bw_main1.win_m_tc4;
	bw_main1.dlg_f1.lpstrCustomFilter=bw_main1.win_m_tc5;
	...
	strcpy(bw_main1.win_m_tc7,bw_main1.dlg_f1.lpstrFile);
	bw_main1.w_fetch_filename(bw_main1.win_m_tc7,FN_SIZE);
*/
