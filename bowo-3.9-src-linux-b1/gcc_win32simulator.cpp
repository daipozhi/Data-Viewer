...
static char cmmn08_str1[5000];
static char cmmn08_str2[5000];
static char cmmn08_str3[5000];
...
int lnx::str_gb18030_to_utf8(char *in_buffer,char *out_buffer,int out_buffer_len)
{
    ...
    cpy_string(out_buffer,out_buffer_len,cmmn08_str2,5000);    
...
static char cmmn07_str1[5000];
static char cmmn07_str2[5000];
static char cmmn07_str3[5000];
...
int lnx::str_utf8_to_gb18030(char *in_buffer,char *out_buffer,int out_buffer_len)
{
    ...
    cpy_string(out_buffer,out_buffer_len,cmmn07_str2,5000);    
