...
int bw_edit::get_edit(char *p_s1,int p_s1_size,int p_wptr,HWND hwnd)
{
  HWND    hnd;
  int     s_hp1;
  int     i,j,k,l;
  ...
  set_win_edit_file(win_edit_ptr1,p_s1,p_s1_size);
...
/*
      ...
      hnd=CreateWindow("edit",NULL
		 ...
		 |ES_AUTOVSCROLL
		 ,0,0,k,l
		 ,bw_main1.win_hwnd,(HMENU)bw_edit1.win_edit_ptr1
