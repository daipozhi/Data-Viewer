...
class bw_buff
{
  ...
  public:
    ...
    int        get_linecol(int p_wptr,int line,int col);
    int        set_linecol(int p_wptr,int line,int col,int val);
/*
};
...
*/
  ...
  public:
    ...
    char       get_t_winfile(int p_wptr,int line,int col);
    int        set_t_winfile(int p_wptr,int line,int col,char val);
};
...
class bw_bmp
{
  ...
  public:
    ...
    int      w_bmp_add(int p_fptr,int p_wptr,char *fldname,int fldname_size);
...
class bw_print
{
  ...
  public:
    ...
    int w_print_page_down(int p_fptr,int p_wptr);
...
{
*/
/* t6_ t5_ t4_ t2_ t_ t7_ is module name */
  ...
  public:
    ...
    int   get_t6_linecol(int fptr,int p02);
    int   set_t6_linecol(int fptr,int p02,int val);

    int   get_t6c_fldname(int fptr,int ptr1);
    int   set_t6c_fldname(int fptr,int ptr1,int val);

    int   get_t6_fldname(int fptr,char *s1,int s1_size);
    int   set_t6_fldname(int fptr,char *s1,int s1_size);
    int   get_t6_fldtype(int fptr);
    int   set_t6_fldtype(int fptr,int val);
    int   get_t6_fldedit(int fptr);
    int   set_t6_fldedit(int fptr,int val);
    int   get_t6_fldbase(int fptr);
    int   set_t6_fldbase(int fptr,int val);
    int   get_t6_fldseri(int fptr);
    int   set_t6_fldseri(int fptr,int val);
    int   get_t6_fldlen(int fptr);
    int   set_t6_fldlen(int fptr,int val);
    int   get_t6_flddec(int fptr);
    int   set_t6_flddec(int fptr,int val);

    long  get_t6_recno(int p_fptr,int form);
    int   set_t6_recno(int p_fptr,int form,long val);

    int   get_t6_eof(int p_fptr,int form);
    int   set_t6_eof(int p_fptr,int form,int val);

    int   get_t7_fldname(int fptr,char *s1,int s1_size);
    int   set_t7_fldname(int fptr,char *s1,int s1_size);

    int   set_c_t7_fldname(int fptr,int cptr,int val);

    int   get_t7_fldseri(int fptr);
    int   set_t7_fldseri(int fptr,int val);
    int   get_t7_fldbase(int fptr);
    int   set_t7_fldbase(int fptr,int val);
    int   get_t7_fldrecn(int fptr);
    int   set_t7_fldrecn(int fptr,int val);
...
class bw_link
{
  ...
  public:
    ...
    int w_keep_linkfld(int p_wptr,int p_fptr,int dir);
...
*/
  ...
  public:
    ...
    int   get_win_continue(int p_fptr,int p_wptr);
    int   set_win_continue(int p_fptr,int p_wptr,int val);
...
class bw_mbase
{
  public:
    ...
    int  w_open_base(char *bn,int bn_size,int p_fptr);
    int  w_close_base(int p_fptr,int p_wptr);

    long w_down_rec(int p_fptr,int p_wptr,long recno);
    long   w_up_rec(int p_fptr,int p_wptr,long recno);
    int  w_save_rec(int p_fptr,int p_wptr,long recno);
    int   w_ins_rec(int p_fptr,int p_wptr,long recno);
    long  w_add_rec(int p_fptr,int p_wptr,long recno);
    int   w_del_rec(int p_fptr,int p_wptr,long recno);
};
...
class bw_xbase
{
  ...
  public:
    ...
    //int  get_xbase_open(int p_fptr,char *s1,int l1,char *s2,int l2);
    //int  get_xbase_close(int p_fptr);

    int  tst_xbase1(void);
    int  tst_xbase2(void);

    long w_read_recno(int fp);
    int  w_open_xbase(char *p_fn1,int p_fn1_size,int backup,int p_fptr);
    int  w_close_xbase(int p_fptr);
    int  w_login_xbase(int ptr);
    int  w_free_xbase(void);
    int  w_dele_state(int p_fptr);
    int  w_create_xbase(char *p_fn12,int p_fn12_size,int p_fptr);
    int  w_compare_xbase(int p_fp,int p_fptr);
    int  w_read_xbase_rec(long recno,int p_fptr);
    int  w_save_xbase_rec(long recno,int p_fptr);
    int  w_append_xbase_rec(long recno,int p_fptr);
    int  w_append_xbase_rec2(int p_fptr);
    int  w_loc_xbase_rec(long recno,int p_fptr);
    long w_up_xbase_rec(long recno,int p_fptr);
    long w_down_xbase_rec(long recno,int p_fptr);
    int  w_xbase_rec_del(void);
    int  w_dele_xbase_rec(long recno,int p_fptr);
    int  w_insert_xbase_rec(long recno,int p_fptr,int aft);
    int  w_insert_xbase_rec2(int p_fptr);
    int  w_pack_xbase_base(int p_fptr);
    int  w_set_xbase_recno(long recno,int p_fptr);
    int  w_set_fox_recno2(long recno,int p_fp);
    int  w_commit_xbase(int backup,int p_fptr);
    int  w_rollback_xbase(/*char *p_fn1,int p_fn1_size,*/int backup,int p_fptr);
    int  w_append_sdf(char *p_fn,int p_fn_size,int p_fptr);
    int  w_copy_sdf(char *p_fn,int p_fn_size,int p_fptr);
    int  w_zap_xbase(int p_fptr);
    int  w_clr_recvar(int p_fptr);
    int  w_find_empty_file(char *str,int str_size,int p_fptr);
    int  w_find_empty_ffile(char *str,int str_size,int p_wptr);
    int  w_find_empty_mfile(char *str,int str_size,int p_fptr);
    int  w_use_fox(char *fn1,int fn1_size);
    int  w_append_fox(int p_fptr);
    int  w_go_fox(long r);
    int  w_close_fox(void);
    int  w_bcpy_var(int p_fptr,char *p_fld,int p_fld_size,char *p_stc4,int p_stc4_size);
    int  w_bsav_var(int p_fptr,char *p_fld,int p_fld_size,char *p_stc4,int p_stc4_size);
...
*/
  ...
  public:
    ...
    int  get_t4_fldname(int fptr,char *s1,int s1_size);
    int  set_t4_fldname(int fptr,char *s1,int s1_size);

    int  get_t4_fldtype(int fptr);
    int  get_t4_fldlen(int fptr);
    int  get_t4_flddec(int fptr);
    int  get_t4_fldposi(int fptr);

    int  set_t4_fldtype(int fptr,int val);
    int  set_t4_fldlen(int fptr,int val);
    int  set_t4_flddec(int fptr,int val);
    int  set_t4_fldposi(int fptr,int val);
};
...
class bw_dialog
{
  ...
  public:
	 ...
	 int      w_echo_winrec_read(int p_fptr,int p_wptr,int mark);
...
class bw_fldstru
{
  ...
  public:
    ...
    int w_fetch_rec(int p_fptr,int p_wptr,int seri);
    ...
    int w_get_tab_var(char *fn,int fn_size,int p_fptr,char *ca,int ca_size);
    int w_cmp_tab_var(char *fn,int fn_size,int p_fptr,char *ca,int ca_size);
    int w_sav_tab_var(char *fn,int fn_size,int p_fptr,char *ca,int ca_size);
    int w_page_up(int p_fptr,int p_wptr);
    int w_page_down(int p_fptr,int p_wptr);
    int w_first_editposi(int p_fptr,int p_wptr);
    int w_last_editposi(int p_fptr,int p_wptr);
    int w_insert_rec(int p_fptr,int p_wptr);
    int w_add_rec(int p_fptr,int p_wptr);
    int w_delete_rec(int p_fptr,int p_wptr);
    int w_rollback_base(int p_fptr,int p_wptr);
    int w_commit_base(int p_fptr,int p_wptr);
    int w_link_window(int p_fptr,int p_wptr);
    int w_is_card(int p_fptr,int p_wptr);
    int w_find_cond(int p_fptr,int p_wptr);
    int w_find_key(int p_fptr,int p_wptr);
    int w_find_recno(int p_fptr,int p_wptr);
    int w_find_end(int p_fptr,int p_wptr);
    int w_find_exit(int p_wptr);
    int w_find_cond_ok(int p_fptr);
    int w_clr_condition(int p_fptr);

    int w_edit_memo(int p_fptr,int p_wptr,char *fldname,int fldname_size);
    int w_edit_memo_close(int p_wptr);
    int w_edit_memo_add(int p_fptr,int p_wptr,char *fldname,int fldname_size);
...
*/
  ...
  public:
    ...
    int w_up_line(int p_fptr,int p_wptr);
    int w_down_line(int p_fptr,int p_wptr);
    int w_up_line2(int p_fptr,int p_wptr);
    int w_down_line2(int p_fptr,int p_wptr);
    int w_last_line(int p_fptr,int p_wptr);
    int w_first_line(int p_fptr,int p_wptr);
    int w_have_next_rec(int p_fptr,int p_wptr);
    int w_have_prev_rec(int p_fptr,int p_wptr);
    int w_be_linked(int p_fptr,int p_wptr);

    int w_have_next_rec2(int p_fptr,int p_wptr,int recno);
    int w_have_prev_rec2(int p_fptr,int p_wptr,int recno);
...
class bw_win
{
  ...
  public:
    ...
    int w_cnt_winline(int p_fptr,int p_wptr,int line);
...
*/
    ...
    int get_win_ptr_wins_dbf(int p_fptr,int p_wptr);
    int set_win_ptr_wins_dbf(int p_fptr,int p_wptr,int val);
    ...
    FARPROC   get_win_fptr(int ptr);
    int       set_win_fptr(int ptr,FARPROC fproc);
