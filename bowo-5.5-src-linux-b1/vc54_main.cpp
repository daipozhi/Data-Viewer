...
*/
    ...
    case WM_TIMER:
      ...
      if (  ((bw_win1.get_win_painted(bw_main1.win_hnd_id)==1)&&(bw_win1.get_win_created(bw_main1.win_hnd_id)==1)) ||
            ((bw_win1.get_win_painted(bw_main1.win_hnd_id)==1)&&(bw_win1.get_win_focused(bw_main1.win_hnd_id)==1))  )
      {


// --- can't adjust cursor when set_focus ---
// --- can't modify pline pfield when set_focus ---
// --- SetFocus() after create,paint,wm_setfocus ---

        i =bw_win1.get_win_linep(bw_main1.win_hnd_id,0);
        j =bw_win1.get_win_linep(bw_main1.win_hnd_id,1);

        bw_win1.w_find_winfname(bw_main1.win_hnd_id,i,j,str1,SMG_SIZE);
...
// --- can't call get_read when set_focus ---
    ...
    case WM_SETFOCUS:
      ...
      //sprintf(str1,"set_focus,win_hnd_id=%d,wp=%d,",bw_main1.win_hnd_id,wp);
...
*/
    ...
    case WM_PAINT:
      ...
      //sprintf(str1,"wm_paint,win_hnd_id=%d,wp=%d,",bw_main1.win_hnd_id,wp);
      //bw_getread1.deb_record(str1);
...
// --- can't set_focus when paint ---
	  ...
	  //SetFocus(bw_win1.get_win_hnd(i));
        ...
        if ((str1[0]=='[')||(str1[0]=='(')) // button,rabox,chkbox
        {
// --- can't set_focus when paint ---
          //i=bw_win1.w_find_hnd(bw_main1.win_hnd_id,bw_win1.pfield,bw_win1.pline);
