...
int bw_print::w_read_page(char *p_fn,int p_fn_size)
{
  ...
  if (p_fn_size<FN_SIZE) j=p_fn_size;
  else  j=FN_SIZE;
  if (j<1) j=1;
  p_fn[j-1]=0;
...
int bw_print::get_t6_fldname(int fldptr,char *p_s1,int p_s1_size)
{
  int i,j;
  ...
  for (j=0;j<i-1;j++)
  {
    p_s1[j+0]=t6_fldname[fldptr][j];
    p_s1[j+1]=0;
  }

  return(0);
}
int bw_print::set_t6_fldname(int fldptr,char *p_s1,int p_s1_size)
{
  int i,j;
...
int bw_print::get_t7_fldname(int fldptr,char *p_s1,int p_s1_size)
{
  int i,j;
  ...
  for (j=0;j<i-1;j++)
  {
    p_s1[j+0]=t7_fldname[fldptr][j];
    p_s1[j+1]=0;
  }

  return(0);
}
int bw_print::set_t7_fldname(int fldptr,char *p_s1,int p_s1_size)
{
  int i,j;
