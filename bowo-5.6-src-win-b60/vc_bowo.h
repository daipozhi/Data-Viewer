...
class bw_win
{
  ...
  public:
    ...
    int w_cre_ci_button(int p_pagecntr,char *s1,int s1_size,int p6,int p7,int p8,int i);
    int w_cre_ci_edit(int p_pagecntr,int p6,int p7,int p8,int i);
    int w_cre_ci_radio(int p_pagecntr,int p6,int p7,int p8,int i);
    int w_cre_ci_check(int p_pagecntr,int p6,int p7,int p8,int i);
