...
int bw_win::w_cre_ci_button(int p_pagecntr,char *p_s1,int p_s1_size,int p6,int p7,int p8,int p9)
{
  HWND hnd;
  int  l,j;
...
int bw_win::w_cre_ci_radio(int p_pagecntr,int p6,int p7,int p8,int p9)
{
  HWND hnd;
...
int bw_win::w_cre_ci_check(int p_pagecntr,int p6,int p7,int p8,int p9)
{
  HWND hnd;
	...
	if (bw_buff1.get_t3_winfile(p_pagecntr,i,j)<=' ')
	{
	  ...
	  if (bw_buff1.get_t3_winfile(p_pagecntr,i,j)!=' ')
	  {
	    if (p5==1)
	    {
		  ...
		  w_cre_ci_button(p_pagecntr,str1,SMG_SIZE,p6,p7,p8,i);
	  ...
	  if (bw_buff1.get_t3_winfile(p_pagecntr,i,j)!=' ')
	  {
	    if (p5==1)
	    {
	      ...
	      else
	      {
	        if (bw_inkey1.strempty(str2,FLD_NAME_SIZE)==1)
		{
		  w_cre_ci_radio(p_pagecntr,p6,p7,p8,i);
	  ...
	  if (bw_buff1.get_t3_winfile(p_pagecntr,i,j)!=' ')
	  {
	    if (p5==1)
	    {
	      ...
	      else
	      {
	        if (bw_inkey1.strempty(str2,FLD_NAME_SIZE)==1)
		{
		  w_cre_ci_check(p_pagecntr,p6,p7,p8,i);
