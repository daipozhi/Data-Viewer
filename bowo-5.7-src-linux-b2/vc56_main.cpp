...
// --- SetFocus() after wm_create,wm_paint,wm_setfocus ---
        ...
        bw_win1.w_find_winfname(bw_main1.win_hnd_id,i,j,tabfld,SMG_SIZE);

                                                            // set ci focus
        if ((tabfld[0]=='[')||(tabfld[0]=='(')||(tabfld[0]=='@')) // button,rabox,chkbox
        {
	  ...
	  SetFocus(bw_win1.get_win_hnd(i));
        ...
        if ((tabfld[0]=='?')||(tabfld[0]=='-')||(tabfld[0]==':')||(tabfld[0]=='+'))
        {
...
*/
	...
	bw_win1.w_find_winfname(bw_main1.win_hnd_id,bw_win1.get_pline(bw_main1.win_hnd_id),bw_win1.get_pcolu(bw_main1.win_hnd_id),tabfld,SMG_SIZE);
...
// --- can't set_focus when paint ---
	  ...
	  //SetFocus(bw_win1.get_win_hnd(i));
        ...
        if ((tabfld[0]=='[')||(tabfld[0]=='(')) // radio box,check box
        {
// --- can't set_focus when paint ---
          //i=bw_win1.w_find_hnd(bw_main1.win_hnd_id,bw_win1.pcolu,bw_win1.pline);
          //SetFocus(bw_win1.get_win_hnd(i));
        ...
        if ((tabfld[0]=='?')||(tabfld[0]=='-')) // mem var
        {
          bw_dialog1.w_mv_get_read_g(tabfld,SMG_SIZE,bw_main1.win_hnd_id,'g');
          ShowCaret(hwnd);
        }

        if ((tabfld[0]==':')||(tabfld[0]=='+')) // dbf field
        {
          i=bw_buff1.get_t3_linecol(bw_main1.win_hnd_id,bw_win1.get_pline(bw_main1.win_hnd_id),bw_win1.get_pcolu(bw_main1.win_hnd_id));
          ...
          if (l==0)
          {
            ...
            bw_fldstru1.w_tv_get_read_g(tabfld,SMG_SIZE,bw_main1.win_hnd_id,bw_win1.get_pline(bw_main1.win_hnd_id),bw_win1.get_pcolu(bw_main1.win_hnd_id),'g');
            ShowCaret(hwnd);
          }
...
*/      
	...
	if ((tabfld[0]=='?')||(tabfld[0]=='-')) // memory var field
	{
	  i=bw_win1.get_pline(bw_main1.win_hnd_id);
          j=bw_win1.get_pcolu(bw_main1.win_hnd_id);

	  if (tabfld[0]=='?')    // save previous field
          {
	    k=bw_dialog1.w_mv_get_read_r(tabfld,SMG_SIZE,bw_main1.win_hnd_id,'r');
	  }
	  else
	  {
	    k=1;
	  ...
	  if (k==1)
	  {
	    if (tabfld[0]=='?')
            {
	      bw_getread1.get_smg_string(bw_win1.get_win_ptr_get_rd(bw_main1.win_hnd_id),fldval,SMG_SIZE);
	    }
	    else
	    {
		...
		GetWindowText(hnd,fldval,SMG_SIZE);
	      }
              else fldval[0]=0;
	    }

	    bw_xbase1.set_win_scrnvar(bw_main1.win_hnd_id,fldval,SMG_SIZE);
	    bw_dialog1.set_win_mv_getv(bw_main1.win_hnd_id,fldval,SMG_SIZE);

	    bw_dialog1.w_mv_sav_var(tabfld,SMG_SIZE,bw_main1.win_hnd_id);
	...
	if ((tabfld[0]==':')||(tabfld[0]=='+')) // database field
	{
	  i=bw_win1.get_pline(bw_main1.win_hnd_id);
	  j=bw_win1.get_pcolu(bw_main1.win_hnd_id);
	  ...
	  if (tabfld[0]==':')  // save previous field
          {
	    k=bw_fldstru1.w_tv_get_read_r(tabfld,SMG_SIZE,bw_main1.win_hnd_id,bw_win1.get_pline(bw_main1.win_hnd_id),bw_win1.get_pcolu(bw_main1.win_hnd_id),'r');
	  }
	  else
	  {
            k=1; // &+fx ci
	  ...
	  if (k==1)
	  {
	    bw_inkey1.cut_string(tabfld,1,strlen(tabfld)-1,SMG_SIZE,fldname,SMG_SIZE);
	    ...
	    n=bw_fldstru1.w_cmp_tab_var(fldname,SMG_SIZE,m,fldval,SMG_SIZE);


            //sprintf(str5, "key msg,comp_tab_var,n=%d,", n);
            //bw_getread1.deb_record(str5);
	    ...
	    if (n==1)
	    {
	      if ((bw_fldstru1.w_find_fldtype(fldname,SMG_SIZE,m)!='m')
              ...
              {
	        bw_fldstru1.w_sav_tab_var(fldname,SMG_SIZE,m,fldval,SMG_SIZE);
	    ...
	    if (bw_main1.win_key==CTRL_E)
	    {
	      if (tabfld[0]==':') bw_xbase1.set_c_win_scrnvar(bw_main1.win_hnd_id,0,0);
	      else
	      {
		q=bw_win1.w_find_hnd(bw_main1.win_hnd_id,bw_win1.get_pcolu(bw_main1.win_hnd_id),bw_win1.get_pline(bw_main1.win_hnd_id));
	        if (q!=0)
	...
	if ((tabfld[0]==':')||(tabfld[0]=='+')) // database field
	{
	  ...
	  bw_xbase1.set_win_scrnvar(bw_main1.win_hnd_id,fldval,SMG_SIZE);
	  //bw_xbase1.get_win_scrnvar(bw_main1.win_hnd_id,fldval,SMG_SIZE);
          n=bw_fldstru1.w_cmp_tab_var(fldname,SMG_SIZE,m,fldval,SMG_SIZE);
	...
	if (m==1)
	{
	  ...
	  bw_dialog1.w_echo_winrec_read(m,bw_main1.win_hnd_id,0/*bw_win1.win_ptr21*/);
...
*/
    ...
    bw_buttonvar1.w_button_poin(tabfld,SMG_SIZE,bw_main1.win_hnd_id);
...
*/
  ...
  if ((tabfld[0]==':')||(tabfld[0]=='+'))
  {
    ...
    if (l==0)
    {
      ...
      //sprintf(tabfld, "win_hnd_id=%d,wp=%d,", win_hnd_id, wp);
...
int bw_main::w_set_lbutton(HWND hwnd,int hnd_id)
{
  ...
  bw_win1.w_find_winfname(hnd_id,bw_win1.get_pline(hnd_id),bw_win1.get_pcolu(hnd_id),tabfld,SMG_SIZE);

  if (tabfld[0]=='@')
  {
    bw_buttonvar1.w_button_poin(tabfld,SMG_SIZE,hnd_id);
  ...
  if (tabfld[0]=='[')
  {
    bw_inkey1.cut_string(tabfld,1,strlen(tabfld)-1-1+1,SMG_SIZE,str2,SMG_SIZE);
...
int bw_main::get_ci_save(int hnd_id)
{
  ...
  bw_win1.w_find_winfname(hnd_id,bw_win1.get_win_linep(hnd_id,0),bw_win1.get_win_linep(hnd_id,1),tabfld,SMG_SIZE);
  ...
  if ((tabfld[0]=='?')||(tabfld[0]=='-'))
  {
    ...
    bw_dialog1.w_mv_sav_var(tabfld,SMG_SIZE,hnd_id);
  }
  ...
  if ((tabfld[0]==':')||(tabfld[0]=='+'))
  {
    ...
    bw_xbase1.set_win_scrnvar(hnd_id,str2,SMG_SIZE);
    bw_xbase1.get_win_scrnvar(hnd_id,fldval,SMG_SIZE);
    o=bw_fldstru1.w_cmp_tab_var(fldname,SMG_SIZE,m,fldval,SMG_SIZE);
