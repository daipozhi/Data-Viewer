...
class bw_link
{
  ...
  public:
    ...
    int w_find_link_cd(int p_wptr,char *tmpc1,int tmpc1_size,int i,int k);
...
class bw_win
{
  ...
  public:
    ...
    int w_cre_ci_button(int p_pagecntr,char *s1,int s1_size,int p6,int p7,int p8,int i,char *,int);
    int w_cre_ci_edit(int p_pagecntr,int p6,int p7,int p8,int i);
    int w_cre_ci_radio(int p_pagecntr,int p6,int p7,int p8,int i,char *,int);
    int w_cre_ci_check(int p_pagecntr,int p6,int p7,int p8,int i,char *,int);
    ...
    int w_echo_winrec_paint(int p_pagecntr,int mark);
    int w_field_info1(int p_pagecntr,int mark);
    int w_cre_win_button(int p_pagecntr,int mark);
    int w_cre_win_edit(int p_pagecntr,int mark);
    int w_cre_win_radio(int p_pagecntr,int mark);
    int w_cre_win_check(int p_pagecntr,int mark);
