...
long  PASCAL w_main_wp(HWND hwnd,UINT msg,WPARAM wp,LPARAM lp)
{
  ...
  switch(msg)    
  {
    ...
    case WM_PAINT:
      ...
      //bw_main1.get_win_face_bmp1(bw_main1.win_face_ptr2,bw_main1.win_face_bmp0,FN_SIZE);
...
/*
      if (wp==1)
      {
	bw_main1.win_face_ptr2++;
	if (bw_main1.win_face_ptr2>10) bw_main1.win_face_ptr2=0;
...
*/
	...
	strcpy(bw_main1.win_m_ts0,bw_main1.win_seaname);
	strcpy(bw_main1.win_m_ts6,"Select File To Run");
	bw_main1.dlg_f1.lStructSize=sizeof(OPENFILENAME);
	bw_main1.dlg_f1.hwndOwner=bw_main1.win_hwnd1;
	strcpy(bw_main1.win_m_ts1,"ALL Text File");
	strcat(bw_main1.win_m_ts1,"(");
	strcat(bw_main1.win_m_ts1,bw_main1.win_m_ts0);
	strcat(bw_main1.win_m_ts1,")");
	j=strlen(bw_main1.win_m_ts1);
	for (i=0;i<=(int)strlen(bw_main1.win_m_ts0);i++) bw_main1.win_m_ts1[j+1+i]=bw_main1.win_m_ts0[i];
	bw_main1.win_m_ts1[j+1+i]=0;
	bw_main1.dlg_f1.lpstrFilter=bw_main1.win_m_ts1;
	bw_main1.dlg_f1.nFilterIndex=1;
	strcpy(bw_main1.win_m_ts2,bw_main1.win_m_ts0);
	bw_main1.dlg_f1.lpstrFile=bw_main1.win_m_ts2;
	bw_main1.dlg_f1.nMaxFile=FN_SIZE;
	bw_main1.dlg_f1.lpstrFileTitle=bw_main1.win_m_ts3;
	bw_main1.dlg_f1.nMaxFileTitle=FN_SIZE;
	bw_main1.dlg_f1.lpstrInitialDir=NULL;
	bw_main1.dlg_f1.lpstrTitle=bw_main1.win_m_ts6;
	strcpy(bw_main1.win_m_ts4,"txt");
	bw_main1.dlg_f1.lpstrDefExt=bw_main1.win_m_ts4;
	bw_main1.dlg_f1.lpstrCustomFilter=bw_main1.win_m_ts5;
	...
	if (bw_inkey1.w_fname_ok(bw_main1.win_seaname,FN_SIZE)==1)
	{
	...
	else bw_win1.w_atten25(bw_main1.win_hwnd1,bw_main1.win_seaname);
      }
...
*/
    ...
    case WM_SIZE:
      ...
      GetWindowRect(bw_main1.win_hwnd1,&bw_main1.rt);
