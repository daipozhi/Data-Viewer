...
class bw_print
{
  ...
  public:
    ...
    int get_win_pvpntr(int vptr,int p01);
    int set_win_pvpntr(int vptr,int p01,int val);
...
*/
  private:
    ...
    int   win_bspntr[COND_NUM][2];   /* link condition string pntr */

    int   win_lkpntr[COND_NUM][2];   /* modi var pntrt */
    ...
    int   win_lkfield[LINK_MODI_NUM]; /* modi var record no.*/
  ...
  public:
    ...
    int   get_win_svpntr(int vptr,int p01);
    int   set_win_svpntr(int vptr,int p01,int val);
    ...
    int   get_win_bspntr(int dptr,int p01);
    int   set_win_bspntr(int dptr,int p01,int val);

    int   get_win_lkpntr(int cptr,int p01);
    int   set_win_lkpntr(int cptr,int p01,int val);
    ...
    int   get_win_lkfield(int lptr);
    int   set_win_lkfield(int lptr,int val);
...
*/
  private:
    ...
    int win_recno[STRU_NUM][WIN_NUM][3];
    int win_rec_cntr[STRU_NUM];
    int  win_fld_cntr[STRU_NUM];
    int  win_len_cntr[STRU_NUM]; /*field number,record lenght */
    ...
    int t4_recnumb[4]; /* 0-record counter,1-field number,2-record length,3-record no. */
  ...
  public:
    ...
    int get_win_recno(int sptr,int p_wptr,int p02);
    int  set_win_recno(int sptr,int p_wptr,int p02,int val);

    int get_win_rec_cntr(int sptr);
    int  set_win_rec_cntr(int sptr,int val);
    int  get_win_fld_cntr(int sptr);
    int  set_win_fld_cntr(int sptr,int val);
    int  get_win_len_cntr(int sptr/*,int p01*/);
    int  set_win_len_cntr(int sptr/*,int p01*/,int val);
    ...
    int read_win_recvar(int fh,int len);
    int write_win_recvar(int fh,int len);
    int  fgets_win_recvar(FILE *fh,int len);
    ...
    int get_t4_recnumb(int p03); 
    int  set_t4_recnumb(int p03,int val);
...
class bw_main
{
  ...
  private:
    ...
    HWND       win_hwnd[WIN_NUM];
    
  public:
  
    HWND       get_win_hwnd(int wptr);
    int        set_win_hwnd(int wptr,HWND val);
...
*/
  ...
  public:
    ...
    //int      get_v_win_mv_getp(int p_wptr);
    //int      set_v_win_mv_getp(int p_wptr,int val);
...
class bw_win
{
  ...
  public:
    ...
    int       win_ptr_new_win;               /* empty array pntr */
    int       win_menu_cmd;
    int       win_menu_seri;
  ...
  public:
    ...
    int w_cre_ci_button(int wptr,char *s1,int s1_size,int p6,int p7,int p8,int i);
    int w_cre_ci_edit(int wptr,int p6,int p7,int p8,int i);
    int w_cre_ci_radio(int wptr,int p6,int p7,int p8,int i);
    int w_cre_ci_check(int wptr,int p6,int p7,int p8,int i);
...
*/
  private:
    ...
    //int           win_ptr_win_mark[WIN_NUM];          /* current table window pntr */
    ...
    int           win_ptr_wins_dbf[STRU_NUM][WIN_NUM];/* database file in buffer, pntr beg & end */
...
*/
    ...
    int      get_win_timer(int p_wptr);
    int       set_win_timer(int p_wptr,int val);
...
*/
  ...
  private:
    ...
    int  win_focus_buf[BW_WIN_FOCUS_NUM];
  ...
  public:
    ...
    int  get_win_focus_buf(int ptr);
    int  set_win_focus_buf(int ptr,int val);
    int  delete_win_focus(int ptr);

  private:

    char win_created[WIN_NUM];
    char win_painted[WIN_NUM];
    char win_focused[WIN_NUM];
    char win_focused_wp[WIN_NUM];

  public:

    int get_win_painted(int);
    int set_win_painted(int,int);
    int get_win_created(int);
    int set_win_created(int,int);
    int get_win_focused(int);
    int set_win_focused(int, int);
    int get_win_focused_wp(int);
    int set_win_focused_wp(int, int);
};
