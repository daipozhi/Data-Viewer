  ...
  if (is_tab==1)  /* it is a table scrn */
  {
	...
	set_mn_ptr_wins_dbf(j,i,0);
      ...
      for (j=0;j<=s_ps;j++)
      {
        ...
        //printf("in read winfile,base=%d,win=%d,set to 1\n",n_base6[j],i);
    ...
    for (s_ps1=0;s_ps1<=s_ps;s_ps1++)  /* fetch stru & base name from m101_str5 */
    {
      ...
      //printf("in read winfile 2,str=%s,base=%d,\n",m101_str5[s_ps1],n_base6[s_ps1]);
	...
	set_ms_tabname(1,n_base6[s_ps1],str_tab2,FN_SIZE);
        ...
        //printf("in read winfile 3,str=%s,base=%d,\n",str_tab2,n_base6[s_ps1]);
	...
	set_ms_tabname(0,n_base6[s_ps1],str_tab2,FN_SIZE);
        ...
        //printf("in read winfile 4,str=%s,base=%d,\n",str_tab2,n_base6[s_ps1]);
