...
#define  FLD_IN_PAGE  50000  /* print model field number */
#define  PAGE_LINE    300   /* print page line number*/
...
class bw_getread
{
 ...
 private:
    ...
    //int   mn_edit_mode[SMG_GET_NUM];/* 0--box,1--line    */
    int   mn_p_y;
    int   mn_p_x;
  ...
  private:
    ...
    int  get_text(int p_wptr,int scrn_l,int scrn_c,char *atten,
    ...
    int  get_txt_after(char *data,int p1);
    int  get_txt_before(char *data,int p1);
